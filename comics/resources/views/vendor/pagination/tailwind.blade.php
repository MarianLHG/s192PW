                        ...
                        @if (is_array($element))
                            @foreach ($element as $page => $url)
                                ...
                                <span aria-current="page"
                                    class="relative z-10 inline-flex items-center px-4 py-2 text-sm font-bold bg-yellow-300 border border-yellow-500 text-black rounded-md shadow focus:z-20">
                                    {{ $page }}
                                </span>
                                @else
