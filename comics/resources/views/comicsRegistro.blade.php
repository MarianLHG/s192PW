    ...
    <div class="product-container">
        ...
        <div class="product-card">
            ...
            <div class="product-details">
                <input type="text" class="product-title-input" value="Uncanny X-Men De Chris Claremont Vol.03 (Marvel Omnibus)" style="width: 100%; font-size: 24px; margin-bottom: 20px; padding: 8px; border: 1px solid #555; background-color: #333; color: white;">
                <div class="product-price-container" style="display: flex; align-items: center; margin-bottom: 30px;">
                    ...
                    <input type="text" class="product-price-input" value="1,393.00" style="width: 80%; font-size: 42px; font-weight: bold; padding: 5px; border: 1px solid #555; background-color: #333; color: white;">
                </div>
                ...
                <div class="product-description">
                    ...
                    <div class="description-content">
                        <div class="description-row">
                            <span>SKU:</span>
                            <span><input type="text" value="XM-CL-VOL3" style="width: 100%; padding: 5px;"></span>
                        </div>
                        <div class="description-row">
                            <span>Año de publicación:</span>
                            <span><input type="text" value="2023" style="width: 100%; padding: 5px;"></span>
                        </div>
                        <div class="description-row">
                            <span>Mes:</span>
                            <span><input type="text" value="Septiembre" style="width: 100%; padding: 5px;"></span>
                        </div>
                        <div class="description-row">
                            <span>Número de páginas:</span>
                            <span><input type="text" value="832" style="width: 100%; padding: 5px;"></span>
                        </div>
                        <div class="description-row">
                            <span>Colección:</span>
                            <span><input type="text" value="Marvel Omnibus" style="width: 100%; padding: 5px;"></span>
                        </div>
                    </div>
                </div>
            </div>
